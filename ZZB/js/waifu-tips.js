...
live2d_settings['l2dVerDate']           = formattedDate; // 版本更新日期
live2d_settings['homePageUrl']          = 'auto';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['aboutPageUrl']         = 'https://www.gfbzb.gov.cn/bydj/';   // 关于页地址, '{URL 网址}'
